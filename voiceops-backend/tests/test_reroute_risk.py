...
def test_check_reroute_available_with_savings():
...
def test_check_reroute_available_insufficient_savings():
...
def test_check_reroute_available_low_severity():
    ...
    async def _run():
        ...
        current_eta = 20
        current_severity = RiskSeverity.LOW
...
def test_check_reroute_available_traffic_api_failure():
...
def test_check_reroute_available_missing_coordinates():
...
def test_check_reroute_available_invalid_driver_id():
...
def test_time_window_with_reroute_integration():
    ...
    async def _run():
        ...
        with patch('app.services.risk_engine.get_next_pending_delivery') as mock_get_delivery:
            ...
            with patch('app.services.risk_engine.eta_service') as mock_eta_service:
