...
async def send_driver_onboarding(
    ...
    payload = {
        ...
        "driver_name": driver_name,
        "phone": phone or "",
        "email": email or operator_email or settings.operator_report_email or "tomarianoor@gmail.com",
        "vehicle_type": vehicle_type or "Not set",
        "operator_name": operator_name or "Kora",
        "operator_email": operator_email or settings.operator_report_email or "tomarianoor@gmail.com",
